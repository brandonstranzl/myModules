...
// With your new knowledge of importing and exporting modules, as well as
// creating private functions and variables, do the following:
...
// Export another function that returns a version of the data list that is
// sorted in ascending order. The function you use to sort the data correctly
// should not be accessible from outside the module. (Think back to the
// Custom Sorting Exercise when handling sorting)
...
var makeList = require("./myModules.js")

makeList.storeInList(5,71,8,9,4)
